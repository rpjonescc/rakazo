...
export function renderTokensCss(): string {
  return `${[
    ...
    renderBlock('[data-theme="dark"] [data-chat-view="slack"]', "dark", chatDarkTokens),
    renderBlock('[data-theme="light"] [data-chat-view="slack"]', "light", chatLightTokens),
  ].join("\n\n")}\n`;
}
